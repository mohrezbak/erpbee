...
from erpbee.accounts.utils import get_fiscal_year, check_if_stock_and_account_balance_synced
from erpbee.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries, process_gl_map
...
class StockController(AccountsController):
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False,
		...
		from erpbee.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from erpbee.stock.utils import validate_warehouse_company
