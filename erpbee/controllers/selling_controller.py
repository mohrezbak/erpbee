...
from erpbee.stock.get_item_details import get_bin_details
from erpbee.stock.utils import get_incoming_rate
from erpbee.stock.get_item_details import get_conversion_factor
from erpbee.stock.doctype.item.item import set_item_default
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from erpbee.accounts.party import _get_party_details
			...
			from erpbee.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from erpbee.controllers.buying_controller import validate_item_type
