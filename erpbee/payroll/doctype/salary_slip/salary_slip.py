...
from erpbee.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates
from erpbee.hr.doctype.employee.employee import get_holiday_list_for_employee
from erpbee.utilities.transaction_base import TransactionBase
from frappe.utils.background_jobs import enqueue
from erpbee.payroll.doctype.additional_salary.additional_salary import get_additional_salary_component
from erpbee.payroll.doctype.payroll_period.payroll_period import get_period_factor, get_payroll_period
from erpbee.payroll.doctype.employee_benefit_application.employee_benefit_application import get_benefit_component_amount
from erpbee.payroll.doctype.employee_benefit_claim.employee_benefit_claim import get_benefit_claim_amount, get_last_payroll_period_benefits
from erpbee.loan_management.doctype.loan_repayment.loan_repayment import calculate_amounts, create_repayment_entry
from erpbee.accounts.utils import get_fiscal_year
...
class SalarySlip(TransactionBase):
	...
	def pull_sal_struct(self):
		from erpbee.payroll.doctype.salary_structure.salary_structure import make_salary_slip
