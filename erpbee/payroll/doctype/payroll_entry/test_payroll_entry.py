...
from erpbee.accounts.utils import get_fiscal_year, getdate, nowdate
from frappe.utils import add_months
from erpbee.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates, get_end_date
from erpbee.hr.doctype.employee.test_employee import make_employee
from erpbee.payroll.doctype.salary_slip.test_salary_slip import get_salary_component_account, \
		make_earning_salary_component, make_deduction_salary_component, create_account, make_employee_salary_slip
from erpbee.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure, create_salary_structure_assignment
from erpbee.loan_management.doctype.loan.test_loan import create_loan, make_loan_disbursement_entry
...
def get_payment_account():
	return frappe.get_value('Account',
		{'account_type': 'Cash', 'company': erpbee.get_default_company(),'is_group':0}, "name")
