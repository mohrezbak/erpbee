...
frappe.ui.form.on('Salary Structure', {
	...
	set_earning_deduction_component: function(frm) {
		...
		frm.set_query("salary_component", "earnings", function() {
			return {
				query : "erpbee.payroll.doctype.salary_structure.salary_structure.get_earning_deduction_components",
	...
	preview_salary_slip: function(frm) {
		frappe.call({
			method: "erpbee.payroll.doctype.salary_structure.salary_structure.get_employees",
			args: {
	...
	open_salary_slip: function(frm, employee){
		...
		frappe.call({
			method: "erpbee.payroll.doctype.salary_structure.salary_structure.make_salary_slip",
			args: {
