...
from erpbee.accounts.report.financial_statements import get_period_list
from erpbee.stock.doctype.warehouse.warehouse import get_child_warehouses
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = erpbee.get_company_currency(self.filters.company)
