...
frappe.ui.form.on('Job Card', {
	setup: function(frm) {
		frm.set_query('operation', function() {
			return {
				query: 'erpbee.manufacturing.doctype.job_card.job_card.get_operations',
				filters: {
	...
	operation: function(frm) {
		...
		if (frm.doc.operation && frm.doc.work_order) {
			frappe.call({
				method: "erpbee.manufacturing.doctype.job_card.job_card.get_operation_details",
				args: {
					"work_order":frm.doc.work_order,
	...
	make_material_request: function(frm) {
		frappe.model.open_mapped_doc({
			method: "erpbee.manufacturing.doctype.job_card.job_card.make_material_request",
			frm: frm,
	...
	make_stock_entry: function(frm) {
		frappe.model.open_mapped_doc({
			method: "erpbee.manufacturing.doctype.job_card.job_card.make_stock_entry",
			frm: frm,
			run_link_triggers: true
		});
	},
