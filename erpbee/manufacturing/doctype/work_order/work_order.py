...
from erpbee.manufacturing.doctype.bom.bom import validate_bom_no, get_bom_items_as_dict, get_bom_item_rate
from dateutil.relativedelta import relativedelta
from erpbee.stock.doctype.item.item import validate_end_of_life, get_item_defaults
from erpbee.manufacturing.doctype.workstation.workstation import WorkstationHolidayError
from erpbee.projects.doctype.timesheet.timesheet import OverlapError
from erpbee.manufacturing.doctype.manufacturing_settings.manufacturing_settings import get_mins_between_operations
from erpbee.stock.stock_balance import get_planned_qty, update_bin_qty
from frappe.utils.csvutils import getlink
from erpbee.stock.utils import get_bin, validate_warehouse_company, get_latest_stock_qty
from erpbee.utilities.transaction_base import validate_uom_is_integer
...
class WorkOrder(Document):
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (("Manufacture", "produced_qty"),
			...
			from erpbee.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
