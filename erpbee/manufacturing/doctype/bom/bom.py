...
from erpbee.stock.get_item_details import get_price_list_rate
from frappe.core.doctype.version.version import get_diff
from erpbee.controllers.queries import get_match_cond
from erpbee.stock.doctype.item.item import get_item_details
...
class BOM(WebsiteGenerator):
	...
	def company_currency(self):
		return erpbee.get_company_currency(self.company)
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None):
	from erpbee.stock.doctype.stock_entry.stock_entry import get_operating_cost_per_unit
...
def make_variant_bom(source_name, bom_no, item, variant_items, target_doc=None):
	from erpbee.manufacturing.doctype.work_order.work_order import add_variant_item
