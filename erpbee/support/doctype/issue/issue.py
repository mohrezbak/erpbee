...
from erpbee.support.doctype.service_level_agreement.service_level_agreement import get_active_service_level_agreement_for
...
def has_website_permission(doc, ptype, user, verbose=False):
	from erpbee.controllers.website_list_for_contact import has_website_permission
