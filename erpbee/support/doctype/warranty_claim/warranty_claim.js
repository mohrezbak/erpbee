...
erpbee.support.WarrantyClaim = frappe.ui.form.Controller.extend({
	refresh: function() {
...
$.extend(cur_frm.cscript, new erpbee.support.WarrantyClaim({frm: cur_frm}));
