...
frappe.ui.form.on('Clinical Procedure', {
	...
	patient: function(frm) {
		if (frm.doc.patient) {
			frappe.call({
				'method': 'erpbee.healthcare.doctype.patient.patient.get_patient_detail',
				args: {
	...
	set_procedure_consumables: function(frm) {
		frappe.call({
			method: 'erpbee.healthcare.doctype.clinical_procedure.clinical_procedure.get_procedure_consumables',
			args: {
