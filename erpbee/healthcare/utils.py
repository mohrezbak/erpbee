...
from erpbee.healthcare.doctype.healthcare_settings.healthcare_settings import get_income_account
from erpbee.healthcare.doctype.fee_validity.fee_validity import create_fee_validity
