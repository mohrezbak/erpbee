...
def execute():
	...
	from erpbee.regional.india.setup import setup
...
<p>Please refer {gst_document_link} to know more about how to setup and implement GST in ERPBee.</p>

<p>Please contact us at support@erpbee.com, if you have any questions.</p>

<p>Thanks,</p>
ERPBee Team.
	""".format(gst_document_link="<a href='http://frappe.github.io/erpbee/user/manual/en/regional/india/'> ERPBee GST Document </a>")

	try:
		sendmail_to_system_managers("[Important] ERPBee GST updates", message)
