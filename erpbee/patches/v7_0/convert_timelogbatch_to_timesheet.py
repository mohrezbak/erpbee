...
def execute():
	...
	from erpbee.manufacturing.doctype.work_order.work_order import add_timesheet_detail
...
def get_timesheet_data(data):
	from erpbee.patches.v7_0.convert_timelog_to_timesheet import get_timelog_data
