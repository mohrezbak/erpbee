...
from erpbee.stock.get_item_details import get_price_list_rate_for, process_args
from erpbee.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
...
class TestItemPrice(unittest.TestCase):
	...
	def test_addition_of_new_fields(self):
		# Based on https://github.com/frappe/erpbee/issues/8456
