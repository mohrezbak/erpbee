...
from erpbee.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
def make_purchase_invoice(source_name, target_doc=None):
	from frappe.model.mapper import get_mapped_doc
	from erpbee.accounts.party import get_payment_terms_template
