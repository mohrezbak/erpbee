...
from erpbee.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from erpbee.stock.doctype.item.test_item import create_item
from erpbee.stock.doctype.serial_no.serial_no import SerialNoDuplicateError
from erpbee.accounts.doctype.account.test_account import get_inventory_account
from erpbee.stock.doctype.item.test_item import make_item
from six import iteritems
from erpbee.stock.doctype.warehouse.test_warehouse import create_warehouse
...
class TestPurchaseReceipt(unittest.TestCase):
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(erpbee.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_subcontracting(self):
		from erpbee.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from erpbee.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from erpbee.buying.doctype.purchase_order.test_purchase_order import (update_backflush_based_on,
			make_subcontracted_item, create_purchase_order)
		from erpbee.buying.doctype.purchase_order.purchase_order import (make_purchase_receipt,
	...
	def test_purchase_return_for_rejected_qty(self):
		from erpbee.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from erpbee.stock.doctype.purchase_receipt.purchase_receipt import update_purchase_receipt_status
	...
	def test_pr_billing_status(self):
		...
		from erpbee.buying.doctype.purchase_order.purchase_order \
	...
	def test_purchase_return_with_submitted_asset(self):
		from erpbee.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from erpbee.buying.doctype.purchase_order.test_purchase_order import create_purchase_order, create_pr_against_po
	...
	def test_subcontracted_pr_for_multi_transfer_batches(self):
		from erpbee.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from erpbee.buying.doctype.purchase_order.purchase_order import make_rm_stock_entry, make_purchase_receipt
		from erpbee.buying.doctype.purchase_order.test_purchase_order import (update_backflush_based_on,
