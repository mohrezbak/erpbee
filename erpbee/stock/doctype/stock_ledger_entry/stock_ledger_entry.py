...
from erpbee.controllers.item_variant import ItemTemplateCannotHaveStock
...
class StockLedgerEntry(Document):
	...
	def on_submit(self):
		...
		if not self.get("via_landed_cost_voucher"):
			from erpbee.stock.doctype.serial_no.serial_no import process_serial_no
	...
	def block_transactions_against_group_warehouse(self):
		from erpbee.stock.utils import is_group_warehouse
