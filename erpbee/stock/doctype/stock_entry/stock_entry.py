...
from erpbee.stock.utils import get_incoming_rate
from erpbee.stock.stock_ledger import get_previous_sle, NegativeStockError, get_valuation_rate
from erpbee.stock.get_item_details import get_bin_details, get_default_cost_center, get_conversion_factor, get_reserved_qty_for_so
...
from erpbee.stock.doctype.batch.batch import get_batch_no, set_batch_nos, get_batch_qty
from erpbee.stock.doctype.item.item import get_item_defaults
from erpbee.manufacturing.doctype.bom.bom import validate_bom_no, add_additional_cost
from erpbee.stock.utils import get_bin
from frappe.model.mapper import get_mapped_doc
from erpbee.stock.doctype.serial_no.serial_no import update_serial_nos_after_submit, get_serial_nos
from erpbee.stock.doctype.stock_reconciliation.stock_reconciliation import OpeningEntryAccountError
...
from erpbee.controllers.stock_controller import StockController
...
class StockEntry(StockController):
		...
		for d in self.get('items'):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				d.basic_rate = get_valuation_rate(d.item_code, d.t_warehouse,
					...
					currency=erpbee.get_company_currency(self.company), company=self.company,
	...
	def get_bom_raw_materials(self, qty):
		from erpbee.manufacturing.doctype.bom.bom import get_bom_items_as_dict
