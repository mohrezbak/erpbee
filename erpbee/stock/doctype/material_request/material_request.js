...
frappe.ui.form.on('Material Request', {
	...
	update_status: function(frm, stop_status) {
		frappe.call({
			method: 'erpbee.stock.doctype.material_request.material_request.update_status',
		...
		frappe.prompt(
			{
				...
				get_query: () => {
					return{
						query: "erpbee.stock.doctype.material_request.material_request.get_default_supplier_query",
	...
	make_request_for_quotation: function(frm) {
		frappe.model.open_mapped_doc({
			method: "erpbee.stock.doctype.material_request.material_request.make_request_for_quotation",
			frm: frm,
			run_link_triggers: true
		});
	},
	...
	make_supplier_quotation: function(frm) {
		frappe.model.open_mapped_doc({
			method: "erpbee.stock.doctype.material_request.material_request.make_supplier_quotation",
			frm: frm
		});
	},
	...
	create_pick_list: (frm) => {
		frappe.model.open_mapped_doc({
			method: "erpbee.stock.doctype.material_request.material_request.create_pick_list",
			frm: frm
		});
	},
	...
	raise_work_orders: function(frm) {
		frappe.call({
			method:"erpbee.stock.doctype.material_request.material_request.raise_work_orders",
			args: {
...
erpbee.buying.MaterialRequestController = erpbee.buying.BuyingController.extend({
	tc_name: function() {
		this.get_terms();
	},
...
$.extend(cur_frm.cscript, new erpbee.buying.MaterialRequestController({frm: cur_frm}));
