...
class TestStudentGroup(unittest.TestCase):
	...
	def test_in_group(self):
		...
		self.assertRaises(erpbee.education.StudentNotInGroupError,
			erpbee.education.validate_student_belongs_to_group, last_student, doc.name)

		# safe, don't throw validation
		erpbee.education.validate_student_belongs_to_group(doc.students[0].student, doc.name)
