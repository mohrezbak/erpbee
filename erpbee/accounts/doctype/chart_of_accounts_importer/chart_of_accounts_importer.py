...
from erpbee.accounts.doctype.account.chart_of_accounts.chart_of_accounts import create_charts, build_tree_from_json
...
def set_default_accounts(company):
	from erpbee.setup.doctype.company.company import install_country_fixtures
