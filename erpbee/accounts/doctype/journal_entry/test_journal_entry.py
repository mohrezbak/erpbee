...
from erpbee.exceptions import InvalidAccountCurrency
from erpbee.accounts.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
...
class TestJournalEntry(unittest.TestCase):
	...
	def test_reverse_journal_entry(self):
		from erpbee.accounts.doctype.journal_entry.journal_entry import make_reverse_journal_entry 
		jv = make_journal_entry("_Test Bank USD - _TC",
