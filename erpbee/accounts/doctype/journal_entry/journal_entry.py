...
from erpbee.controllers.accounts_controller import AccountsController
from erpbee.accounts.utils import get_balance_on, get_stock_accounts, get_stock_and_account_balance, \
...
from erpbee.accounts.doctype.invoice_discounting.invoice_discounting \
	import get_party_account_based_on_invoice_discounting
from erpbee.accounts.deferred_revenue import get_deferred_booking_accounts
...
class JournalEntry(AccountsController):
	...
	def on_cancel(self):
		...
		from erpbee.payroll.doctype.salary_slip.salary_slip import unlink_ref_doc_from_salary_slip
...
def get_default_bank_cash_account(company, account_type=None, mode_of_payment=None, account=None):
	from erpbee.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
	if mode_of_payment:
...
def get_outstanding(args):
	...
	company_currency = erpbee.get_company_currency(args.get("company"))
