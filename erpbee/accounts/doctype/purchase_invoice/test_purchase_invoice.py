...
from erpbee.stock.doctype.purchase_receipt.test_purchase_receipt import make_purchase_receipt, get_taxes
from erpbee.controllers.accounts_controller import get_payment_terms
from erpbee.exceptions import InvalidCurrency
from erpbee.stock.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
...
class TestPurchaseInvoice(unittest.TestCase):
	...
	def test_gl_entries_without_perpetual_inventory(self):
		...
		self.assertTrue(not cint(erpbee.is_perpetual_inventory_enabled(pi.company)))
		pi.insert()
		pi.submit()
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		self.assertTrue(cint(erpbee.is_perpetual_inventory_enabled(pi.company)), 1)
