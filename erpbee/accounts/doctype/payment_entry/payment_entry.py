...
import frappe, erpbee, json
from frappe import _, scrub, ValidationError
from frappe.utils import flt, comma_or, nowdate, getdate
from erpbee.accounts.utils import get_outstanding_invoices, get_account_currency, get_balance_on
from erpbee.accounts.party import get_party_account
from erpbee.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from erpbee.setup.utils import get_exchange_rate
from erpbee.accounts.general_ledger import make_gl_entries
from erpbee.hr.doctype.expense_claim.expense_claim import update_reimbursed_amount
from erpbee.accounts.doctype.bank_account.bank_account import get_party_bank_account, get_bank_account_details
from erpbee.controllers.accounts_controller import AccountsController, get_supplier_block_status
from erpbee.accounts.doctype.invoice_discounting.invoice_discounting import get_party_account_based_on_invoice_discounting
...
class PaymentEntry(AccountsController):
	...
	def set_payment_req_status(self):
		from erpbee.accounts.doctype.payment_request.payment_request import update_payment_req_status
		...
		if self.party:
			...
			if self.party_account and self.party_type in ("Customer", "Supplier"):
				self.validate_account_type(self.party_account,
					[erpbee.get_party_account_type(self.party_type)])
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = "credit" if erpbee.get_party_account_type(self.party_type) == 'Receivable' else "debit"
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or erpbee.get_company_currency(ref_doc.company)
