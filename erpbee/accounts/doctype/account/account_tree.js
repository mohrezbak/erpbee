...
frappe.treeview_settings["Account"] = {
	...
	filters: [
		{
			...
			on_change: function() {
				...
				frappe.call({
					method: "erpbee.accounts.doctype.account.account.get_root_company",
					args: {
						company: company,
					},
					callback: function(r) {
	...
	root_label: "Accounts",
	get_tree_nodes: 'erpbee.accounts.utils.get_children',
	add_tree_node: 'erpbee.accounts.utils.add_ac',
	menu_items:[
		{
