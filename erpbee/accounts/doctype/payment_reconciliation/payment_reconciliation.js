...
erpbee.accounts.PaymentReconciliationController = frappe.ui.form.Controller.extend({
	onload: function() {
		var me = this;
...
$.extend(cur_frm.cscript, new erpbee.accounts.PaymentReconciliationController({frm: cur_frm}));
