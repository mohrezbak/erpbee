...
from erpbee.accounts.doctype.pos_invoice.pos_invoice import make_sales_return
...
class TestPOSInvoice(unittest.TestCase):
	...
	def test_loyalty_points(self):
		from erpbee.accounts.doctype.loyalty_program.test_loyalty_program import create_records
		from erpbee.accounts.doctype.loyalty_program.loyalty_program import get_loyalty_program_details_with_points
