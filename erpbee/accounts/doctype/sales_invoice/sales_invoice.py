...
from erpbee.controllers.selling_controller import SellingController
from erpbee.accounts.utils import get_account_currency
from erpbee.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
from erpbee.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from erpbee.assets.doctype.asset.depreciation \
	import get_disposal_account_and_cost_center, get_gl_entries_on_asset_disposal
from erpbee.stock.doctype.batch.batch import set_batch_nos
from erpbee.stock.doctype.serial_no.serial_no import get_serial_nos, get_delivery_note_serial_no
from erpbee.setup.doctype.company.company import update_company_current_month_sales
from erpbee.accounts.general_ledger import get_round_off_account_and_cost_center
from erpbee.accounts.doctype.loyalty_program.loyalty_program import \
	get_loyalty_program_details_with_points, get_loyalty_details, validate_loyalty_points
from erpbee.accounts.deferred_revenue import validate_service_stop_date

from erpbee.healthcare.utils import manage_invoice_submit_cancel
...
class SalesInvoice(SellingController):
	...
	def check_credit_limit(self):
		from erpbee.selling.doctype.customer.customer import check_credit_limit
	...
	def set_pos_fields(self, for_validate=False):
		...
		from erpbee.stock.get_item_details import get_pos_profile_item_details, get_pos_profile
	...
	def update_packing_list(self):
		if cint(self.update_stock) == 1:
			from erpbee.stock.doctype.packed_item.packed_item import make_packing_list
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from erpbee.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries
	...
	def get_gl_entries(self, warehouse_account=None):
		from erpbee.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and \
			erpbee.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from erpbee.accounts.doctype.loyalty_point_entry.loyalty_point_entry \
	...
	def set_healthcare_services(self, checked_values):
		self.set("items", [])
		from erpbee.stock.get_item_details import get_item_details
...
def get_loyalty_programs(customer):
	...
	from erpbee.selling.doctype.customer.customer import get_loyalty_programs
...
def create_dunning(source_name, target_doc=None):
	from frappe.model.mapper import get_mapped_doc
	from erpbee.accounts.doctype.dunning.dunning import get_dunning_letter_text, calculate_interest_and_amount
	def set_missing_values(source, target):
