...
frappe.ui.form.on("Sales Order Item", {
	...
	delivery_date: function(frm, cdt, cdn) {
		if(!frm.doc.delivery_date) {
			erpbee.utils.copy_value_in_all_rows(frm.doc, cdt, cdn, "items", "delivery_date");
		}
	}
});

erpbee.selling.SalesOrderController = erpbee.selling.SellingController.extend({
			...
			this.frm.add_custom_button(__('Quotation'),
				function() {
					erpbee.utils.map_current_doc({
						method: "erpbee.selling.doctype.quotation.quotation.make_sales_order",
	...
	create_pick_list() {
		frappe.model.open_mapped_doc({
			method: "erpbee.selling.doctype.sales_order.sales_order.create_pick_list",
			frm: this.frm
		})
	},
	...
	make_material_request: function() {
		frappe.model.open_mapped_doc({
			method: "erpbee.selling.doctype.sales_order.sales_order.make_material_request",
			frm: this.frm
		})
	},
	...
	make_raw_material_request_dialog: function(r) {
		...
		var d = new frappe.ui.Dialog({
			...
			primary_action: function() {
				var data = d.get_values();
				me.frm.call({
					method: 'erpbee.selling.doctype.sales_order.sales_order.make_raw_material_request',
					args: {
						items: data,
						company: me.frm.doc.company,
						sales_order: me.frm.docname,
	...
	make_maintenance_schedule: function() {
		frappe.model.open_mapped_doc({
			method: "erpbee.selling.doctype.sales_order.sales_order.make_maintenance_schedule",
			frm: this.frm
		})
	},
	...
	make_project: function() {
		frappe.model.open_mapped_doc({
			method: "erpbee.selling.doctype.sales_order.sales_order.make_project",
			frm: this.frm
		})
	},
	...
	make_inter_company_order: function() {
		frappe.model.open_mapped_doc({
			method: "erpbee.selling.doctype.sales_order.sales_order.make_inter_company_purchase_order",
			frm: this.frm
		});
	},
	...
	make_maintenance_visit: function() {
		frappe.model.open_mapped_doc({
			method: "erpbee.selling.doctype.sales_order.sales_order.make_maintenance_visit",
			frm: this.frm
		})
	},
	...
	make_purchase_order: function(){
		...
		var dialog = new frappe.ui.Dialog({
			...
			primary_action (args) {
				...
				return frappe.call({
					method: "erpbee.selling.doctype.sales_order.sales_order." + method,
					freeze: true,
	...
	update_status: function(label, status){
		...
		frappe.call({
			method: "erpbee.selling.doctype.sales_order.sales_order.update_status",
...
$.extend(cur_frm.cscript, new erpbee.selling.SalesOrderController({frm: cur_frm}));
