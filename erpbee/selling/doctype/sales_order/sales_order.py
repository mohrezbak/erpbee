...
from erpbee.stock.stock_balance import update_bin_qty, get_reserved_qty
...
from erpbee.manufacturing.doctype.production_plan.production_plan import get_items_for_material_requests
...
class SalesOrder(SellingController):
	...
	def validate(self):
		...
		if self.coupon_code:
			from erpbee.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from erpbee.accounts.doctype.pricing_rule.utils import update_coupon_code_count
