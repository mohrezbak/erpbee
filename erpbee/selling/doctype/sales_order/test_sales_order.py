...
from erpbee.selling.doctype.sales_order.sales_order import make_work_orders
from erpbee.controllers.accounts_controller import update_child_qty_rate
from erpbee.selling.doctype.sales_order.sales_order import make_raw_material_request
from erpbee.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from erpbee.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
...
class TestSalesOrder(unittest.TestCase):
	...
	def test_drop_shipping(self):
		from erpbee.selling.doctype.sales_order.sales_order import make_purchase_order_for_default_supplier, \
			update_status as so_update_status
		from erpbee.buying.doctype.purchase_order.purchase_order import update_status
	...
	def test_serial_no_based_delivery(self):
		...
		so.submit()
		from erpbee.manufacturing.doctype.work_order.test_work_order import \
		...
		from erpbee.manufacturing.doctype.work_order.work_order import \
		...
		si.update_stock = 0
		si.submit()
		from erpbee.accounts.doctype.sales_invoice.sales_invoice import \
