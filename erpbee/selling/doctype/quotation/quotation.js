...
erpbee.selling.QuotationController = erpbee.selling.SellingController.extend({
	...
	get_lead_details: function() {
		...
		frappe.call({
			method: "erpbee.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(erpbee.selling.QuotationController);
