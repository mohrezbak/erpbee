{% include "erpbee/selling/page/point_of_sale/onscan.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_item_selector.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_item_cart.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_item_details.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_payment.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_number_pad.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_past_order_list.js" %}
{% include "erpbee/selling/page/point_of_sale/pos_past_order_summary.js" %}

erpbee.PointOfSale.Controller = class {
	constructor(wrapper) {
	...
	load_assets() {
		...
		frappe.require(['assets/erpbee/css/pos.css'], this.check_opening_entry.bind(this));
	}

	fetch_opening_entry() {
		return frappe.call("erpbee.selling.page.point_of_sale.point_of_sale.check_opening_entry", { "user": frappe.session.user });
	}
	...
	create_opening_voucher() {
		...
		const dialog = new frappe.ui.Dialog({
			...
			primary_action: async ({ company, pos_profile, balance_details }) => {
				...
				const method = "erpbee.selling.page.point_of_sale.point_of_sale.create_opening_voucher";
	...
	init_item_selector() {
		this.item_selector = new erpbee.PointOfSale.ItemSelector({
	...
	init_item_cart() {
		this.cart = new erpbee.PointOfSale.ItemCart({
			wrapper: this.$components_wrapper,
			settings: this.settings,
			events: {
				get_frm: () => this.frm,
	...
	init_item_details() {
		this.item_details = new erpbee.PointOfSale.ItemDetails({
			wrapper: this.$components_wrapper,
			events: {
				get_frm: () => this.frm,
	...
	init_payments() {
		this.payment = new erpbee.PointOfSale.Payment({
			wrapper: this.$components_wrapper,
			events: {
				get_frm: () => this.frm || {},
	...
	init_recent_order_list() {
		this.recent_order_list = new erpbee.PointOfSale.PastOrderList({
			wrapper: this.$components_wrapper,
			events: {
	...
	init_order_summary() {
		this.order_summary = new erpbee.PointOfSale.PastOrderSummary({
			wrapper: this.$components_wrapper,
			events: {
				get_frm: () => this.frm,
	...
	async make_return_invoice(doc) {
		...
		const res = await frappe.call({
			method: "erpbee.accounts.doctype.pos_invoice.pos_invoice.make_sales_return",
			args: {
	...
	async check_serial_no_availablilty(item_code, warehouse, serial_no) {
		const method = "erpbee.stock.doctype.serial_no.serial_no.get_pos_reserved_serial_nos";
	...
	get_available_stock(item_code, warehouse) {
		const me = this;
		return frappe.call({
			method: "erpbee.accounts.doctype.pos_invoice.pos_invoice.get_stock_availability",
			args: {
				'item_code': item_code,
				'warehouse': warehouse,
			},
