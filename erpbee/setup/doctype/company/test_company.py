...
from erpbee.accounts.doctype.account.chart_of_accounts.chart_of_accounts import get_charts_for_country
...
class TestCompany(unittest.TestCase):
	...
	def test_delete_communication(self):
		from erpbee.setup.doctype.company.delete_company_transactions import delete_communications
