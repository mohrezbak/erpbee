...
from erpbee.crm.doctype.utils import get_scheduled_employees_for_popup, strip_number
from frappe.contacts.doctype.contact.contact import get_contact_with_phone_number
from erpbee.crm.doctype.lead.lead import get_lead_with_phone_number
