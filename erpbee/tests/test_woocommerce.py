...
import unittest, frappe, requests, os, time, erpbee
from erpbee.erpbee_integrations.connectors.woocommerce_connection import order
...
def emulate_request():
	...
	url = "http://{site}:{port}/api/method/erpbee.erpbee_integrations.connectors.woocommerce_connection.order".format(site=host, port=port)
