...
import erpbee
import frappe.utils
from erpbee.demo.user import hr, sales, purchase, manufacturing, stock, accounts, projects, fixed_asset
from erpbee.demo.user import education as edu
from erpbee.demo.setup import education, manufacture, setup_data, healthcare, retail
"""
Make a demo

1. Start with a fresh account

bench --site demo.erpbee.dev reinstall

2. Install Demo

bench --site demo.erpbee.dev execute erpbee.demo.demo.make

3. If Demo breaks, to continue

bench --site demo.erpbee.dev execute erpbee.demo.demo.simulate
