...
import frappe, random, json, erpbee
...
from erpbee.stock.doctype.material_request.material_request import make_request_for_quotation
from erpbee.buying.doctype.request_for_quotation.request_for_quotation import \
...
def work():
	...
	company_currency = frappe.get_cached_value('Company', erpbee.get_default_company(), "default_currency")
	party_account_currency = get_party_account_currency("Supplier", supplier, erpbee.get_default_company())
...
def make_subcontract():
	from erpbee.buying.doctype.purchase_order.purchase_order import make_rm_stock_entry
