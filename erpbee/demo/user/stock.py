...
import frappe, random, erpbee
from frappe.desk import query_report
from erpbee.stock.stock_ledger import NegativeStockError
from erpbee.stock.doctype.serial_no.serial_no import SerialNoRequiredError, SerialNoQtyError
from erpbee.stock.doctype.batch.batch import UnableToSelectBatchError
from erpbee.stock.doctype.delivery_note.delivery_note import make_sales_return
...
def make_stock_reconciliation():
	...
	from erpbee.stock.doctype.stock_reconciliation.stock_reconciliation \
	...
	if random.random() < 0.4:
		...
		stock_reco.company = erpbee.get_default_company()
