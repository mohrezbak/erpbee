...
from erpbee.non_profit.doctype.member.member import create_member
...
class Membership(Document):
	def validate(self):
		...
		last_membership = erpbee.get_last_membership()
...
Administrator""".format(get_link_to_form("Error Log", log.name))
		sendmail_to_system_managers("[Important] [ERPBee] Razorpay membership webhook failed , please check.", content)
	except:
		pass
