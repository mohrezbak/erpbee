...
const docsUrl = 'https://erpbee.com/docs/';
...
frappe.help.help_links['Form/Customize Form'] = [
	{ label: 'Custom Field', url: docsUrl + 'user/manual/en/customize-erpbee/custom-field' },
	{ label: 'Customize Field', url: docsUrl + 'user/manual/en/customize-erpbee/customize-form' },
]
