frappe.provide("erpbee.financial_statements");

erpbee.financial_statements = {
	"filters": get_filters(),
	"formatter": function(value, row, column, data, default_formatter) {
		if (data && column.fieldname=="account") {
			...
			column.link_onclick =
				"erpbee.financial_statements.open_general_ledger(" + JSON.stringify(data) + ")";
			column.is_tree = true;
		}
	...
	onload: function(report) {
		...
		erpbee.financial_statements.filters = get_filters()
...
function get_filters() {
	let filters = [
		...
		// accordingly.
		{
			...
			"label": __("Currency"),
			"fieldtype": "Select",
			"options": erpbee.get_presentation_currency_list()
		},
		{
