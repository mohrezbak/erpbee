frappe.provide("erpbee.timesheet");

erpbee.timesheet.timer = function(frm, row, timestamp=0) {
	...
	erpbee.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

erpbee.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
