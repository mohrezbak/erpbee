		...
		list_view.page.add_inner_button(__("Bulk Leave Policy Assignment"), function () {
			me.dialog = new frappe.ui.form.MultiSelectDialog({
				...
				action(employees, data) {
					frappe.call({
						method: 'erpbee.hr.doctype.leave_policy_assignment.leave_policy_assignment.create_assignment_for_multiple_employees',
						async: false,
						args: {
							employees: employees,
							data: data
		...
		list_view.page.add_inner_button(__("Grant Leaves"), function () {
			me.dialog = new frappe.ui.form.MultiSelectDialog({
				...
				action(leave_policy_assignments) {
					frappe.call({
						method: 'erpbee.hr.doctype.leave_policy_assignment.leave_policy_assignment.grant_leave_for_multiple_employees',
						async: false,
						args: {
