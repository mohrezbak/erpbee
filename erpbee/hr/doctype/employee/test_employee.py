...
import unittest
import frappe.utils
from erpbee.hr.doctype.employee.employee import EmployeeLeftValidationError
...
class TestEmployee(unittest.TestCase):
	def test_birthday_reminders(self):
		...
		from erpbee.hr.doctype.employee.employee import get_employees_who_are_born_today, send_birthday_reminders
