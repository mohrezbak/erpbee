...
erpbee.hr.AttendanceControlPanel = frappe.ui.form.Controller.extend({
	onload: function() {
	...
	get_template:function() {
		...
		window.location.href = repl(frappe.request.url +
			...
			cmd: "erpbee.hr.doctype.upload_attendance.upload_attendance.get_template",
	...
	show_upload() {
		...
		new frappe.ui.FileUploader({
			wrapper: $wrapper,
			method: 'erpbee.hr.doctype.upload_attendance.upload_attendance.upload'
		});
	},
...
cur_frm.cscript = new erpbee.hr.AttendanceControlPanel({frm: cur_frm});
