...
from erpbee.hr.utils import set_employee_name
...
def make_bank_entry(dt, dn):
	...
	je.append("accounts", {
		...
		"cost_center": erpbee.get_default_cost_center(expense_claim.company),
...
def get_expense_claim_account_and_cost_center(expense_claim_type, company):
	...
	cost_center = erpbee.get_default_cost_center(company)
