...
frappe.provide("erpbee_integrations.shopify_settings");

frappe.ui.form.on("Shopify Settings", "onload", function(frm){
	frappe.call({
		method:"erpbee.erpbee_integrations.doctype.shopify_settings.shopify_settings.get_series",
		callback:function(r){
	...
	erpbee_integrations.shopify_settings.setup_queries(frm);
})
...
$.extend(erpbee_integrations.shopify_settings, {
