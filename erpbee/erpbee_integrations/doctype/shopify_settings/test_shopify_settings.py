...
from erpbee.erpbee_integrations.connectors.shopify_connection import create_order
from erpbee.erpbee_integrations.doctype.shopify_settings.sync_product import make_item
...
class ShopifySettings(unittest.TestCase):
	def setUp(self):
		...
		import_doc(path=frappe.get_app_path("erpbee", "erpbee_integrations/doctype/shopify_settings/test_data/custom_field.json"),
