...
from erpbee.erpbee_integrations.doctype.plaid_settings.plaid_connector import PlaidConnector
...
def automatic_synchronization():
	...
	if settings.enabled == 1 and settings.automatic_sync == 1:
		...
		for plaid_account in plaid_accounts:
			frappe.enqueue(
				"erpbee.erpbee_integrations.doctype.plaid_settings.plaid_settings.sync_transactions",
