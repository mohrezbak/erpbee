...
from erpbee.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice as make_pi_from_pr
from erpbee.stock.doctype.material_request.test_material_request import make_material_request
...
from erpbee.controllers.accounts_controller import update_child_qty_rate
from erpbee.controllers.status_updater import OverAllowanceError
from erpbee.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order

from erpbee.stock.doctype.batch.test_batch import make_new_batch
from erpbee.controllers.buying_controller import get_backflushed_subcontracted_raw_materials
...
class TestPurchaseOrder(unittest.TestCase):
	...
	def test_return_against_purchase_order(self):
		...
		from erpbee.stock.doctype.purchase_receipt.test_purchase_receipt \
				import make_purchase_receipt as make_purchase_receipt_return
		from erpbee.accounts.doctype.purchase_invoice.test_purchase_invoice \
	...
	def test_warehouse_company_validation(self):
		from erpbee.stock.utils import InvalidWarehouseCompany
		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from erpbee.utilities.transaction_base import UOMMustBeIntegerError
