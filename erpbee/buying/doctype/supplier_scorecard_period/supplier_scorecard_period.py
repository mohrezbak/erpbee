...
import erpbee.buying.doctype.supplier_scorecard_variable.supplier_scorecard_variable as variable_functions
from erpbee.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria import get_variables
